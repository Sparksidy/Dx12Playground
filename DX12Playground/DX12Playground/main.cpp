    ...
    ComPtr<IDXGISwapChain4> swapChain, ComPtr<ID3D12DescriptorHeap> descriptorHeap)
{
    ...
    for (int i = 0; i < g_NumFrames; ++i)
    {
        ...
        rtvHandle.ptr += (1 * rtvDescriptorSize); // ALAIN
    }
}
...
void Render()
{
    ...
    // Clear the render target.
    {
        ...
        barrier.Transition.Subresource = D3D12_RESOURCE_BARRIER_ALL_SUBRESOURCES;// CHANGED
        ...
        rtvHandle.ptr = g_RTVDescriptorHeap->GetCPUDescriptorHandleForHeapStart().ptr + g_CurrentBackBufferIndex * g_RTVDescriptorSize;

        g_CommandList->ClearRenderTargetView(rtvHandle, clearColor, 0, nullptr); // CHANGED
    }
